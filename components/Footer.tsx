      ...
      <div className='flex flex-col gap-12 w-full'>
          ...
          <p className='text-start text-sm font-normal mt-5 max-w-xs'>Flexibble is the world&apos;s leading community for creatives to share, grow, and get hired. </p>
           ...
           <div className="flex flex-wrap gap-12">
            ...
            <div className='flex-1 flex flex-col gap-4'>
               ...
               <FooterColumn title={footerLinks[3].title} links={footerLinks[0].links} />
            <div className='flex-1 flex flex-col gap-4'>
       ...
       <div className='flexBetween footer_copyright'>
        <p> @2023 Flexibble. All Rights Reserved</p>
         <p className='text-gray'> <span className='text-black font-semibold'>10,2014</span>Projects Submitted </p>      
         </div>
    </footer>
  )
}
